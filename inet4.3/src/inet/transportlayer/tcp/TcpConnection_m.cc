...
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    return basedesc ? 69+basedesc->getFieldCount() : 69;
}
...
int TcpStateVariablesDescriptor::findField(const char *fieldName) const
{
    ...
    if (fieldName[0] == 'n' && strcmp(fieldName, "nagle_enabled") == 0) return base+23;
    if (fieldName[0] == 'd' && strcmp(fieldName, "delayed_acks_enabled") == 0) return base+24;
    if (fieldName[0] == 'l' && strcmp(fieldName, "limited_transmit_enabled") == 0) return base+25;
    if (fieldName[0] == 'i' && strcmp(fieldName, "increased_IW_enabled") == 0) return base+26;
    if (fieldName[0] == 'f' && strcmp(fieldName, "full_sized_segment_counter") == 0) return base+27;
    if (fieldName[0] == 'a' && strcmp(fieldName, "ack_now") == 0) return base+28;
    if (fieldName[0] == 'a' && strcmp(fieldName, "afterRto") == 0) return base+29;
    if (fieldName[0] == 'w' && strcmp(fieldName, "ws_support") == 0) return base+30;
    if (fieldName[0] == 'w' && strcmp(fieldName, "ws_enabled") == 0) return base+31;
    if (fieldName[0] == 'w' && strcmp(fieldName, "ws_manual_scale") == 0) return base+32;
    if (fieldName[0] == 's' && strcmp(fieldName, "snd_ws") == 0) return base+33;
    if (fieldName[0] == 'r' && strcmp(fieldName, "rcv_ws") == 0) return base+34;
    if (fieldName[0] == 'r' && strcmp(fieldName, "rcv_wnd_scale") == 0) return base+35;
    if (fieldName[0] == 's' && strcmp(fieldName, "snd_wnd_scale") == 0) return base+36;
    if (fieldName[0] == 't' && strcmp(fieldName, "ts_support") == 0) return base+37;
    if (fieldName[0] == 't' && strcmp(fieldName, "ts_enabled") == 0) return base+38;
    if (fieldName[0] == 's' && strcmp(fieldName, "snd_initial_ts") == 0) return base+39;
    if (fieldName[0] == 'r' && strcmp(fieldName, "rcv_initial_ts") == 0) return base+40;
    if (fieldName[0] == 't' && strcmp(fieldName, "ts_recent") == 0) return base+41;
    if (fieldName[0] == 'l' && strcmp(fieldName, "last_ack_sent") == 0) return base+42;
    if (fieldName[0] == 't' && strcmp(fieldName, "time_last_data_sent") == 0) return base+43;
    if (fieldName[0] == 's' && strcmp(fieldName, "sack_support") == 0) return base+44;
    if (fieldName[0] == 's' && strcmp(fieldName, "sack_enabled") == 0) return base+45;
    if (fieldName[0] == 's' && strcmp(fieldName, "snd_sack_perm") == 0) return base+46;
    if (fieldName[0] == 'r' && strcmp(fieldName, "rcv_sack_perm") == 0) return base+47;
    if (fieldName[0] == 's' && strcmp(fieldName, "start_seqno") == 0) return base+48;
    if (fieldName[0] == 'e' && strcmp(fieldName, "end_seqno") == 0) return base+49;
    if (fieldName[0] == 's' && strcmp(fieldName, "snd_sack") == 0) return base+50;
    if (fieldName[0] == 's' && strcmp(fieldName, "snd_dsack") == 0) return base+51;
    if (fieldName[0] == 'h' && strcmp(fieldName, "highRxt") == 0) return base+52;
    if (fieldName[0] == 'p' && strcmp(fieldName, "pipe") == 0) return base+53;
    if (fieldName[0] == 'r' && strcmp(fieldName, "recoveryPoint") == 0) return base+54;
    if (fieldName[0] == 's' && strcmp(fieldName, "sackedBytes") == 0) return base+55;
    if (fieldName[0] == 's' && strcmp(fieldName, "sackedBytes_old") == 0) return base+56;
    if (fieldName[0] == 'l' && strcmp(fieldName, "lossRecovery") == 0) return base+57;
    if (fieldName[0] == 's' && strcmp(fieldName, "sendQueueLimit") == 0) return base+58;
    if (fieldName[0] == 'q' && strcmp(fieldName, "queueUpdate") == 0) return base+59;
    if (fieldName[0] == 'd' && strcmp(fieldName, "dupacks") == 0) return base+60;
    if (fieldName[0] == 's' && strcmp(fieldName, "snd_sacks") == 0) return base+61;
    if (fieldName[0] == 'r' && strcmp(fieldName, "rcv_sacks") == 0) return base+62;
    if (fieldName[0] == 'r' && strcmp(fieldName, "rcv_oooseg") == 0) return base+63;
    if (fieldName[0] == 'r' && strcmp(fieldName, "rcv_naseg") == 0) return base+64;
    if (fieldName[0] == 'm' && strcmp(fieldName, "maxRcvBuffer") == 0) return base+65;
    if (fieldName[0] == 'u' && strcmp(fieldName, "usedRcvBuffer") == 0) return base+66;
    if (fieldName[0] == 'f' && strcmp(fieldName, "freeRcvBuffer") == 0) return base+67;
    if (fieldName[0] == 't' && strcmp(fieldName, "tcpRcvQueueDrops") == 0) return base+68;
    return basedesc ? basedesc->findField(fieldName) : -1;
}
