...
const cPacket * PacketJitterTimer::getJitteredPacket() const
{
    return this->jitteredPacket;
}

void PacketJitterTimer::setJitteredPacket(cPacket * jitteredPacket)
{
    if (this->jitteredPacket != nullptr) throw omnetpp::cRuntimeError("setJitteredPacket(): a value is already set, remove it first with dropJitteredPacket()");
    this->jitteredPacket = jitteredPacket;
    if (this->jitteredPacket != nullptr)
        take(this->jitteredPacket);
}

cPacket * PacketJitterTimer::dropJitteredPacket()
{
    cPacket * retval = this->jitteredPacket;
    if (retval != nullptr)
        drop(retval);
...
int PacketJitterTimerDescriptor::findField(const char *fieldName) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    int base = basedesc ? basedesc->getFieldCount() : 0;
    if (fieldName[0] == 'j' && strcmp(fieldName, "jitteredPacket") == 0) return base+0;
    return basedesc ? basedesc->findField(fieldName) : -1;
}
...
int PacketJitterTimerDescriptor::getFieldArraySize(void *object, int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
    ...
    PacketJitterTimer *pp = (PacketJitterTimer *)object; (void)pp;
    switch (field) {
        default: return 0;
    }
}

void PacketJitterTimerDescriptor::setFieldArraySize(void *object, int field, int size) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount()) {
...
const char *PacketJitterTimerDescriptor::getFieldDynamicTypeString(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
    ...
    PacketJitterTimer *pp = (PacketJitterTimer *)object; (void)pp;
    switch (field) {
        case FIELD_jitteredPacket: { const cPacket * value = pp->getJitteredPacket(); return omnetpp::opp_typename(typeid(*value)); }
        default: return nullptr;
    }
}

std::string PacketJitterTimerDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
    ...
    PacketJitterTimer *pp = (PacketJitterTimer *)object; (void)pp;
    switch (field) {
        case FIELD_jitteredPacket: {std::stringstream out; out << pp->getJitteredPacket(); return out.str();}
        default: return "";
    }
}

void PacketJitterTimerDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount()) {
...
const char *PacketJitterTimerDescriptor::getFieldStructName(int field) const
{
    ...
    switch (field) {
        case FIELD_jitteredPacket: return omnetpp::opp_typename(typeid(cPacket));
        default: return nullptr;
    };
}

void *PacketJitterTimerDescriptor::getFieldStructValuePointer(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
    ...
    PacketJitterTimer *pp = (PacketJitterTimer *)object; (void)pp;
    switch (field) {
        case FIELD_jitteredPacket: return toVoidPtr(pp->getJitteredPacket()); break;
        default: return nullptr;
    }
}

void PacketJitterTimerDescriptor::setFieldStructValuePointer(void *object, int field, int i, void *ptr) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount()) {
    ...
    PacketJitterTimer *pp = (PacketJitterTimer *)object; (void)pp;
    switch (field) {
        case FIELD_jitteredPacket: pp->setJitteredPacket((cPacket *)ptr); break;
        default: throw omnetpp::cRuntimeError("Cannot set field %d of class 'PacketJitterTimer'", field);
    }
}
