...
/**
 * Enum generated from <tt>inet/networklayer/wiseroute/WiseRouteHeader.msg:28</tt> by nedtool.
 * <pre>
...
/**
 * Class generated from <tt>inet/networklayer/wiseroute/WiseRouteHeader.msg:34</tt> by nedtool.
 * <pre>
...
class INET_API WiseRouteHeader : public ::inet::NetworkHeaderBase
{
  protected:
    ...
    int isFlood = 0;
    int nbHops = 0;
    inet::WiseRouteMsgType headerKind = static_cast<WiseRouteMsgType>(-1);
  ...
  public:
    ...
    virtual inet::WiseRouteMsgType getHeaderKind() const;
    virtual void setHeaderKind(inet::WiseRouteMsgType headerKind);
