...
/**
 * Enum generated from <tt>inet/routing/dymo/Dymo.msg:29</tt> by nedtool.
 * <pre>
...
/**
 * Class generated from <tt>inet/routing/dymo/Dymo.msg:48</tt> by nedtool.
 * <pre>
...
/**
 * Class generated from <tt>inet/routing/dymo/Dymo.msg:65</tt> by nedtool.
 * <pre>
 * message RreqTimer
 * {
 *     L3Address target;
...
/**
 * Class generated from <tt>inet/routing/dymo/Dymo.msg:80</tt> by nedtool.
 * <pre>
 * message PacketJitterTimer
 * {
 *     cPacket *jitteredPacket \@owned = nullptr;
 * }
 * 
 * //
 * // Dymo packets
...
{
  protected:
    cPacket * jitteredPacket = nullptr;
  ...
  public:
    ...
    // field getter/setter methods
    virtual const cPacket * getJitteredPacket() const;
    virtual cPacket * getJitteredPacketForUpdate() { return const_cast<cPacket *>(const_cast<PacketJitterTimer*>(this)->getJitteredPacket());}
    virtual cPacket * dropJitteredPacket();
    virtual void setJitteredPacket(cPacket * jitteredPacket);
};
